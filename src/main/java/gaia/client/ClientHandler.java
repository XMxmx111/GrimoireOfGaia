...
public class ClientHandler {
	...
	public static final ModelLayerLocation CECAELIA = new ModelLayerLocation(new ResourceLocation(GrimoireOfGaia.MOD_ID, "cecaelia"), "main");
	...
	public static final ModelLayerLocation COBBLE_GOLEM = new ModelLayerLocation(new ResourceLocation(GrimoireOfGaia.MOD_ID, "cobble_golem"), "main");
	public static final ModelLayerLocation COBBLESTONE_GOLEM = new ModelLayerLocation(new ResourceLocation(GrimoireOfGaia.MOD_ID, "cobblestone_golem"), "main");
	...
	public static final ModelLayerLocation CYAN_FLOWER = new ModelLayerLocation(new ResourceLocation(GrimoireOfGaia.MOD_ID, "cyan_flower"), "main");
	...
	public static final ModelLayerLocation DEATHWORD = new ModelLayerLocation(new ResourceLocation(GrimoireOfGaia.MOD_ID, "deathword"), "main");
	...
	public static final ModelLayerLocation DWARF = new ModelLayerLocation(new ResourceLocation(GrimoireOfGaia.MOD_ID, "dwarf"), "main");
	public static final ModelLayerLocation ENDER_EYE = new ModelLayerLocation(new ResourceLocation(GrimoireOfGaia.MOD_ID, "ender_eye"), "main");
	public static final ModelLayerLocation ENDER_DRAGON_GIRL = new ModelLayerLocation(new ResourceLocation(GrimoireOfGaia.MOD_ID, "ender_dragon_girl"), "main");
	public static final ModelLayerLocation FLESH_LICH = new ModelLayerLocation(new ResourceLocation(GrimoireOfGaia.MOD_ID, "flesh_lich"), "main");
	...
	public static final ModelLayerLocation GRAVEMITE = new ModelLayerLocation(new ResourceLocation(GrimoireOfGaia.MOD_ID, "gravemite"), "main");
	...
	public static final ModelLayerLocation MANDRAGORA = new ModelLayerLocation(new ResourceLocation(GrimoireOfGaia.MOD_ID, "mandragora"), "main");
	...
	public static final ModelLayerLocation MINOTAUR = new ModelLayerLocation(new ResourceLocation(GrimoireOfGaia.MOD_ID, "minotaur"), "main");
	...
	public static final ModelLayerLocation MUMMY = new ModelLayerLocation(new ResourceLocation(GrimoireOfGaia.MOD_ID, "mummy"), "main");
	public static final ModelLayerLocation NAGA = new ModelLayerLocation(new ResourceLocation(GrimoireOfGaia.MOD_ID, "naga"), "main");
	...
	public static final ModelLayerLocation TOAD = new ModelLayerLocation(new ResourceLocation(GrimoireOfGaia.MOD_ID, "toad"), "main");
	public static final ModelLayerLocation VALKYRIE = new ModelLayerLocation(new ResourceLocation(GrimoireOfGaia.MOD_ID, "valkyrie"), "main");
	...
	public static void addPackFinders(AddPackFindersEvent event) {
		...
		if (event.getPackType() == PackType.CLIENT_RESOURCES) {
			event.addPackFinders(new ResourceLocation(GrimoireOfGaia.MOD_ID, "optional_sound_pack"), PackType.CLIENT_RESOURCES,
...
//			event.addRepositorySource((packConsumer) -> packConsumer.accept(pack));
	...
	public static void registerEntityRenders(EntityRenderersEvent.RegisterRenderers event) {
		...
		event.registerEntityRenderer(GaiaRegistry.CECAELIA.getEntityType(), CecaeliaRenderer::new);
		...
		event.registerEntityRenderer(GaiaRegistry.COBBLE_GOLEM.getEntityType(), CobbleGolemRenderer::new);
		event.registerEntityRenderer(GaiaRegistry.COBBLESTONE_GOLEM.getEntityType(), CobblestoneGolemRenderer::new);
		...
		event.registerEntityRenderer(GaiaRegistry.CYAN_FLOWER.getEntityType(), CyanFlowerRenderer::new);
		event.registerEntityRenderer(GaiaRegistry.DEATHWORD.getEntityType(), DeathwordRenderer::new);
		...
		event.registerEntityRenderer(GaiaRegistry.DWARF.getEntityType(), DwarfRenderer::new);
		event.registerEntityRenderer(GaiaRegistry.ENDER_EYE.getEntityType(), EnderEyeRenderer::new);
		event.registerEntityRenderer(GaiaRegistry.ENDER_DRAGON_GIRL.getEntityType(), EnderDragonGirlRenderer::new);
		event.registerEntityRenderer(GaiaRegistry.FLESH_LICH.getEntityType(), FleshLichRenderer::new);
		...
		event.registerEntityRenderer(GaiaRegistry.GRAVEMITE.getEntityType(), GraveMiteRenderer::new);
		...
		event.registerEntityRenderer(GaiaRegistry.MANDRAGORA.getEntityType(), MandragoraRenderer::new);
		...
		event.registerEntityRenderer(GaiaRegistry.MINOTAUR.getEntityType(), MinotaurRenderer::new);
		...
		event.registerEntityRenderer(GaiaRegistry.MUMMY.getEntityType(), MummyRenderer::new);
		event.registerEntityRenderer(GaiaRegistry.NAGA.getEntityType(), NagaRenderer::new);
		...
		event.registerEntityRenderer(GaiaRegistry.TOAD.getEntityType(), ToadRenderer::new);
		event.registerEntityRenderer(GaiaRegistry.VALKYRIE.getEntityType(), ValkyrieRenderer::new);
...
//		event.registerEntityRenderer(GaiaRegistry.WERESHEEP.getEntityType(), WeresheepRenderer::new);
	...
	public static void registerLayerDefinitions(EntityRenderersEvent.RegisterLayerDefinitions event) {
		...
		event.registerLayerDefinition(CECAELIA, CecaeliaModel::createBodyLayer);
		...
		event.registerLayerDefinition(COBBLE_GOLEM, CobbleGolemModel::createBodyLayer);
		event.registerLayerDefinition(COBBLESTONE_GOLEM, CobblestoneGolemModel::createBodyLayer);
		...
		event.registerLayerDefinition(CYAN_FLOWER, CyanFlowerModel::createBodyLayer);
		event.registerLayerDefinition(DEATHWORD, DeathwordModel::createBodyLayer);
		...
		event.registerLayerDefinition(DWARF, DwarfModel::createBodyLayer);
		event.registerLayerDefinition(ENDER_EYE, EnderEyeModel::createBodyLayer);
		event.registerLayerDefinition(ENDER_DRAGON_GIRL, EnderDragonGirlModel::createBodyLayer);
		event.registerLayerDefinition(FLESH_LICH, FleshLichModel::createBodyLayer);
		...
		event.registerLayerDefinition(GRAVEMITE, GraveMiteModel::createBodyLayer);
		...
		event.registerLayerDefinition(MANDRAGORA, MandragoraModel::createBodyLayer);
		...
		event.registerLayerDefinition(MINOTAUR, MinotaurModel::createBodyLayer);
		...
		event.registerLayerDefinition(MUMMY, MummyModel::createBodyLayer);
		event.registerLayerDefinition(NAGA, NagaModel::createBodyLayer);
		...
		event.registerLayerDefinition(TOAD, ToadModel::createBodyLayer);
		event.registerLayerDefinition(VALKYRIE, ValkyrieModel::createBodyLayer);
