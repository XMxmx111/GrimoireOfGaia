...
public class ShamanModel extends EntityModel<Shaman> implements HeadedModel, ArmedModel {
	...
	public static LayerDefinition createBodyLayer() {
		...
		PartDefinition bodybottom = shaman.addOrReplaceChild("bodybottom", CubeListBuilder.create().texOffs(0, 30).addBox(-3.0F, -1.5F, -1.5F, 6.0F, 3.0F, 3.0F), PartPose.offsetAndRotation(0.0F, -13.5F, 0.0F, 0.0873F, 0.0F, 0.0F));
		...
		PartDefinition hair = head.addOrReplaceChild("hair", CubeListBuilder.create().texOffs(36, 14).addBox(-4.5F, -7.5F, 0.5F, 9.0F, 9.0F, 6.0F), PartPose.offset(0.0F, 0.0F, 0.0F));

		PartDefinition hat1 = head.addOrReplaceChild("hat1", CubeListBuilder.create().texOffs(36, 29).addBox(-2.5F, -8.5F, 4.0F, 5.0F, 5.0F, 7.0F)
				.texOffs(36, 41).addBox(-2.0F, -8.5F, -2.0F, 4.0F, 3.0F, 6.0F), PartPose.offsetAndRotation(0.0F, 0.0F, 0.0F, 0.6981F, 0.0F, 0.0F));
		...
		PartDefinition rightarmlower = rightarm.addOrReplaceChild("rightarmlower", CubeListBuilder.create().texOffs(16, 18).addBox(-1.005F, 0.0F, -2.0F, 2.0F, 6.0F, 2.0F)
				.texOffs(78, 6).addBox(-1.5F, 3.0F, -2.5F, 3.0F, 2.0F, 3.0F), PartPose.offset(-1.0F, 5.0F, 1.0F));

		PartDefinition rightpauldron = rightarm.addOrReplaceChild("rightpauldron", CubeListBuilder.create().texOffs(80, 0).addBox(-3.5F, -1.5F, -1.5F, 4.0F, 3.0F, 3.0F), PartPose.offsetAndRotation(0.0F, 0.0F, 0.0F, 0.0F, 0.0F, 0.2618F));

		PartDefinition leftarm = bodytop.addOrReplaceChild("leftarm", CubeListBuilder.create().texOffs(16, 36).addBox(0.0F, -1.0F, -1.0F, 2.0F, 6.0F, 2.0F), PartPose.offsetAndRotation(2.5F, -4.5F, -1.0F, 0.0873F, 0.0F, -0.1745F));
		...
		PartDefinition leftarmlower = leftarm.addOrReplaceChild("leftarmlower", CubeListBuilder.create().texOffs(16, 42).addBox(-0.995F, 0.0F, -2.0F, 2.0F, 6.0F, 2.0F)
				.texOffs(66, 6).addBox(-1.5F, 3.0F, -2.5F, 3.0F, 2.0F, 3.0F), PartPose.offset(1.0F, 5.0F, 1.0F));

		PartDefinition leftpauldron = leftarm.addOrReplaceChild("leftpauldron", CubeListBuilder.create().texOffs(66, 0).addBox(-0.5F, -1.0F, -1.5F, 4.0F, 3.0F, 3.0F), PartPose.offsetAndRotation(0.0F, 0.0F, 0.0F, 0.0F, 0.0F, -0.2618F));

		PartDefinition backpack = bodybottom.addOrReplaceChild("backpack", CubeListBuilder.create().texOffs(66, 11).addBox(-3.0F, 0.0F, 0.0F, 6.0F, 4.0F, 3.0F), PartPose.offsetAndRotation(0.0F, -1.5F, 1.0F, 0.3491F, 0.0F, 0.0F));

		PartDefinition waist1 = bodybottom.addOrReplaceChild("waist1", CubeListBuilder.create().texOffs(66, 18).addBox(-3.5F, -2.0F, -2.0F, 7.0F, 6.0F, 4.0F), PartPose.offsetAndRotation(0.0F, 0.0F, 0.0F, 0.1745F, 0.0F, 0.0F));

		PartDefinition waist2 = waist1.addOrReplaceChild("waist2", CubeListBuilder.create().texOffs(66, 28).addBox(-4.0F, -0.1F, -4.0F, 8.0F, 7.0F, 4.0F), PartPose.offsetAndRotation(0.0F, -0.9F, 1.5F, 0.1745F, 0.0F, 0.0F));

		PartDefinition rightleg = shaman.addOrReplaceChild("rightleg", CubeListBuilder.create().texOffs(24, 12).addBox(-1.5F, -1.0F, -1.5F, 3.0F, 7.0F, 3.0F), PartPose.offset(-2.0F, -13.0F, 0.0F));
		...
		PartDefinition rightleglower = rightleg.addOrReplaceChild("rightleglower", CubeListBuilder.create().texOffs(24, 19).addBox(-1.505F, 0.0F, 0.0F, 3.0F, 7.0F, 3.0F)
				.texOffs(94, 0).addBox(-2.0F, 4.0F, -0.5F, 4.0F, 2.0F, 4.0F), PartPose.offset(0.0F, 6.0F, -1.5F));

		PartDefinition leftleg = shaman.addOrReplaceChild("leftleg", CubeListBuilder.create().texOffs(24, 36).addBox(-1.5F, -1.0F, -1.5F, 3.0F, 7.0F, 3.0F), PartPose.offset(2.0F, -13.0F, 0.0F));

		PartDefinition leftleglower = leftleg.addOrReplaceChild("leftleglower", CubeListBuilder.create().texOffs(24, 43).addBox(-1.495F, 0.0F, 0.0F, 3.0F, 7.0F, 3.0F)
				.texOffs(94, 0).addBox(-2.0F, 4.0F, -0.5F, 4.0F, 2.0F, 4.0F), PartPose.offset(0.0F, 6.0F, -1.5F));
