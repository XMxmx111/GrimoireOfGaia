...
public class CyclopsModel extends EntityModel<Cyclops> implements HeadedModel, ArmedModel {
	...
	public static LayerDefinition createBodyLayer() {
		...
		PartDefinition bodybottom = cyclops.addOrReplaceChild("bodybottom", CubeListBuilder.create().texOffs(0, 30).addBox(-3.0F, -1.5F, -1.5F, 6.0F, 3.0F, 3.0F), PartPose.offsetAndRotation(0.0F, -13.5F, 0.0F, 0.0873F, 0.0F, 0.0F));
		...
		PartDefinition hairribbon = head.addOrReplaceChild("hairribbon", CubeListBuilder.create().texOffs(36, 29).addBox(-2.5F, -1.5F, -1.0F, 5.0F, 3.0F, 7.0F), PartPose.offsetAndRotation(0.0F, -4.5F, 1.5F, 0.7854F, 0.0F, 0.0F));
		...
		PartDefinition lefthorn_r1 = horns.addOrReplaceChild("lefthorn_r1", CubeListBuilder.create().texOffs(36, 39).addBox(-0.5F, -0.5F, -2.5F, 1.0F, 1.0F, 3.0F), PartPose.offsetAndRotation(-2.0F, 0.0F, -1.0F, 0.0F, -0.2618F, 0.0F));

		PartDefinition righthorn_r1 = horns.addOrReplaceChild("righthorn_r1", CubeListBuilder.create().texOffs(36, 39).addBox(-0.5F, -0.5F, -2.5F, 1.0F, 1.0F, 3.0F), PartPose.offsetAndRotation(2.0F, 0.0F, -1.0F, 0.0F, 0.2618F, 0.0F));

		PartDefinition hair = neck.addOrReplaceChild("hair", CubeListBuilder.create().texOffs(36, 14).addBox(-1.5F, -1.5F, -0.5F, 3.0F, 6.0F, 3.0F), PartPose.offset(0.0F, -3.5F, 3.0F));
		...
		PartDefinition rightarm = bodytop.addOrReplaceChild("rightarm", CubeListBuilder.create().texOffs(16, 12).addBox(-2.0F, -1.0F, -1.0F, 2.0F, 6.0F, 2.0F)
				.texOffs(50, 43).mirror().addBox(-3.0F, -2.0F, -2.0F, 3.0F, 5.0F, 4.0F).mirror(false), PartPose.offsetAndRotation(-2.5F, -4.5F, -1.0F, 0.1745F, 0.0F, 0.1745F));
		...
		PartDefinition rightarmlower = rightarm.addOrReplaceChild("rightarmlower", CubeListBuilder.create().texOffs(16, 18).addBox(-1.005F, 0.0F, -2.0F, 2.0F, 6.0F, 2.0F)
				.texOffs(46, 52).mirror().addBox(-1.5F, 0.0F, -2.5F, 2.0F, 5.0F, 3.0F).mirror(false), PartPose.offset(-1.0F, 5.0F, 1.0F));

		PartDefinition leftarm = bodytop.addOrReplaceChild("leftarm", CubeListBuilder.create().texOffs(16, 36).addBox(0.0F, -1.0F, -1.0F, 2.0F, 6.0F, 2.0F)
				.texOffs(36, 43).mirror().addBox(0.0F, -2.0F, -2.0F, 3.0F, 5.0F, 4.0F).mirror(false), PartPose.offsetAndRotation(2.5F, -4.5F, -1.0F, 0.1745F, 0.0F, -0.1745F));

		PartDefinition leftarmlower = leftarm.addOrReplaceChild("leftarmlower", CubeListBuilder.create().texOffs(16, 42).addBox(-0.995F, 0.0F, -2.0F, 2.0F, 6.0F, 2.0F)
				.texOffs(36, 52).mirror().addBox(-0.5F, 0.0F, -2.5F, 2.0F, 5.0F, 3.0F).mirror(false), PartPose.offset(1.0F, 5.0F, 1.0F));

		PartDefinition rightleg = cyclops.addOrReplaceChild("rightleg", CubeListBuilder.create().texOffs(24, 12).addBox(-1.5F, -1.0F, -1.5F, 3.0F, 7.0F, 3.0F), PartPose.offset(-2.0F, -13.0F, 0.0F));

		PartDefinition rightlegupper = rightleg.addOrReplaceChild("rightlegupper", CubeListBuilder.create().texOffs(64, 10).addBox(-2.0F, -1.5F, -2.0F, 4.0F, 7.0F, 4.0F), PartPose.offset(0.0F, 0.0F, 0.0F));

		PartDefinition rightleglower = rightleg.addOrReplaceChild("rightleglower", CubeListBuilder.create().texOffs(24, 19).addBox(-1.505F, 0.0F, 0.0F, 3.0F, 7.0F, 3.0F), PartPose.offset(0.0F, 6.0F, -1.5F));

		PartDefinition leftleg = cyclops.addOrReplaceChild("leftleg", CubeListBuilder.create().texOffs(24, 12).addBox(-1.5F, -1.0F, -1.5F, 3.0F, 7.0F, 3.0F), PartPose.offset(2.0F, -13.0F, 0.0F));

		PartDefinition leftlegupper = leftleg.addOrReplaceChild("leftlegupper", CubeListBuilder.create().texOffs(64, 10).mirror().addBox(-2.0F, -1.5F, -2.0F, 4.0F, 7.0F, 4.0F).mirror(false), PartPose.offset(0.0F, 0.0F, 0.0F));

		PartDefinition leftleglower = leftleg.addOrReplaceChild("leftleglower", CubeListBuilder.create().texOffs(24, 19).addBox(-1.495F, 0.0F, 0.0F, 3.0F, 7.0F, 3.0F), PartPose.offset(0.0F, 6.0F, -1.5F));
