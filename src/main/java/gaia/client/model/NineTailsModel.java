...
public class NineTailsModel extends EntityModel<NineTails> implements HeadedModel, ArmedModel {
	...
	public static LayerDefinition createBodyLayer() {
		...
		PartDefinition bodytop = bodymiddle.addOrReplaceChild("bodytop", CubeListBuilder.create().texOffs(0, 16).addBox(-2.5F, -6.0F, -2.5F, 5.0F, 6.0F, 3.0F)
				.texOffs(64, 0).addBox(-1.5F, -3.0F, -3.6F, 3.0F, 2.0F, 1.0F), PartPose.offsetAndRotation(0.0F, -2.0F, 0.5F, -0.0873F, 0.0F, 0.0F));
		...
		PartDefinition rightear = head.addOrReplaceChild("rightear", CubeListBuilder.create().texOffs(36, 37).mirror().addBox(-3.0F, -4.0F, -1.5F, 3.0F, 4.0F, 3.0F).mirror(false), PartPose.offsetAndRotation(3.5F, -6.5F, 0.0F, 0.0F, 0.0F, -0.0873F));
		...
		PartDefinition chest = bodytop.addOrReplaceChild("chest", CubeListBuilder.create().texOffs(0, 36).addBox(-2.2F, 0.0F, -2.0F, 2.0F, 2.0F, 2.0F)
				.texOffs(0, 36).addBox(0.2F, 0.0F, -2.0F, 2.0F, 2.0F, 2.0F), PartPose.offsetAndRotation(0.0F, -5.5F, -2.6F, 0.7854F, 0.0F, 0.0F));
		...
		PartDefinition rightarm = bodytop.addOrReplaceChild("rightarm", CubeListBuilder.create().texOffs(16, 12).addBox(-2.0F, -1.0F, -1.0F, 2.0F, 6.0F, 2.0F)
				.texOffs(64, 3).addBox(-3.0F, 0.5F, -2.0F, 4.0F, 2.0F, 4.0F)
				.texOffs(64, 9).addBox(-2.5F, 2.0F, -1.5F, 3.0F, 3.0F, 3.0F), PartPose.offsetAndRotation(-2.5F, -4.5F, -1.0F, 0.0873F, 0.0F, 0.1745F));
		...
		PartDefinition rightarmlower = rightarm.addOrReplaceChild("rightarmlower", CubeListBuilder.create().texOffs(16, 20).addBox(-1.005F, 0.0F, -2.5F, 2.0F, 6.0F, 2.0F)
				.texOffs(64, 15).addBox(-1.505F, 0.0F, -3.0F, 3.0F, 5.0F, 3.0F), PartPose.offset(-1.0F, 5.0F, 1.5F));
		...
		PartDefinition leftarm = bodytop.addOrReplaceChild("leftarm", CubeListBuilder.create().texOffs(16, 12).addBox(0.0F, -1.0F, -1.0F, 2.0F, 6.0F, 2.0F)
				.texOffs(64, 3).mirror().addBox(-1.0F, 0.5F, -2.0F, 4.0F, 2.0F, 4.0F).mirror(false)
				.texOffs(64, 9).mirror().addBox(-0.5F, 2.0F, -1.5F, 3.0F, 3.0F, 3.0F).mirror(false), PartPose.offsetAndRotation(2.5F, -4.5F, -1.0F, 0.0873F, 0.0F, -0.1745F));

		PartDefinition leftarmlower = leftarm.addOrReplaceChild("leftarmlower", CubeListBuilder.create().texOffs(16, 20).addBox(-0.995F, 0.0F, -2.5F, 2.0F, 6.0F, 2.0F)
				.texOffs(64, 15).mirror().addBox(-1.495F, 0.0F, -3.0F, 3.0F, 5.0F, 3.0F).mirror(false), PartPose.offset(1.0F, 5.0F, 1.5F));
		...
		PartDefinition rightleg = nine_tails.addOrReplaceChild("rightleg", CubeListBuilder.create().texOffs(24, 12).addBox(-1.5F, -1.0F, -1.5F, 3.0F, 7.0F, 3.0F)
				.texOffs(86, 0).addBox(-2.0F, -1.0F, -2.0F, 4.0F, 4.0F, 4.0F), PartPose.offsetAndRotation(-2.0F, -13.0F, 0.0F, 0.0F, -0.0436F, -0.0436F));
		...
		PartDefinition rightleglower = rightleg.addOrReplaceChild("rightleglower", CubeListBuilder.create().texOffs(24, 22).addBox(-1.505F, 0.0F, 0.0F, 3.0F, 7.0F, 3.0F)
				.texOffs(86, 8).addBox(-1.5F, 5.0F, -0.5F, 3.0F, 1.0F, 4.0F), PartPose.offset(0.0F, 6.0F, -1.5F));

		PartDefinition leftleg = nine_tails.addOrReplaceChild("leftleg", CubeListBuilder.create().texOffs(24, 12).addBox(-1.5F, -1.0F, -1.5F, 3.0F, 7.0F, 3.0F)
				.texOffs(86, 0).mirror().addBox(-2.0F, -1.0F, -2.0F, 4.0F, 4.0F, 4.0F).mirror(false), PartPose.offsetAndRotation(2.0F, -13.0F, 0.0F, 0.0F, 0.0436F, 0.0436F));

		PartDefinition leftleglower = leftleg.addOrReplaceChild("leftleglower", CubeListBuilder.create().texOffs(24, 22).addBox(-1.495F, 0.0F, 0.0F, 3.0F, 7.0F, 3.0F)
				.texOffs(86, 8).addBox(-1.5F, 5.0F, -0.5F, 3.0F, 1.0F, 4.0F), PartPose.offset(0.0F, 6.0F, -1.5F));
