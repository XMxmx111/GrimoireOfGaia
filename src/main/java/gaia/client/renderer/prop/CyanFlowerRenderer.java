...
public class CyanFlowerRenderer extends MobRenderer<CyanFlower, CyanFlowerModel> {
	public static final ResourceLocation CYAN_FLOWER_LOCATION = ResourceLocation.fromNamespaceAndPath(GrimoireOfGaia.MOD_ID, "textures/entity/mandragora/mandragora_flower.png");
