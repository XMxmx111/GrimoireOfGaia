...
public class WizardHarpyEyesLayer extends EyesLayer<WizardHarpy, WizardHarpyModel> {
	private static final RenderType WIZARD_HARPY_EYES = RenderType.eyes(ResourceLocation.fromNamespaceAndPath(GrimoireOfGaia.MOD_ID, "textures/entity/wizard_harpy/wizard_harpy_eyes.png"));
