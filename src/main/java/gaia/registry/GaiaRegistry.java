...
//	public static final MobReg<Weresheep> WERESHEEP = new MobReg.Builder<>("weresheep", GaiaMobType.PASSIVE, EntityType.Builder.of(Weresheep::new, MobCategory.CREATURE).sized(0.6F, 1.99F).clientTrackingRange(8)).traderEgg().withDefaultSounds().build();
	...
	//Blocks
	public static final DeferredBlock<Block> BUST_GORGON = BLOCKS.register("bust_gorgon", () -> new DecorationBlock(Block.Properties.of().mapColor(MapColor.STONE).strength(1.5F, 6F).sound(SoundType.STONE)));
	public static final DeferredBlock<Block> BUST_MINOTAUR = BLOCKS.register("bust_minotaur", () -> new DecorationBlock(Block.Properties.of().mapColor(MapColor.STONE).strength(1.5F, 6F).sound(SoundType.STONE)));
	public static final DeferredBlock<Block> BUST_SPHINX = BLOCKS.register("bust_sphinx", () -> new DecorationBlock(Block.Properties.of().mapColor(MapColor.STONE).strength(1.5F, 6F).sound(SoundType.STONE)));
	public static final DeferredBlock<Block> BUST_VALKYRIE = BLOCKS.register("bust_valkyrie", () -> new DecorationBlock(Block.Properties.of().mapColor(MapColor.STONE).strength(1.5F, 6F).sound(SoundType.STONE)));
	public static final DeferredBlock<Block> BUST_VAMPIRE = BLOCKS.register("bust_vampire", () -> new DecorationBlock(Block.Properties.of().mapColor(MapColor.STONE).strength(1.5F, 6F).sound(SoundType.STONE)));
	public static final DeferredBlock<Block> DECO_GARDEN_GNOME = BLOCKS.register("deco_garden_gnome", () -> new DecorationBlock(Block.Properties.of().mapColor(MapColor.STONE).strength(0.8F, 6F).sound(SoundType.STONE)));
	public static final DeferredBlock<Block> DECO_MANDRAGORA_POT = BLOCKS.register("deco_mandragora_pot", () -> new DecorationBlock(Block.Properties.of().mapColor(MapColor.STONE).strength(0.8F, 6F).sound(SoundType.STONE)));
	public static final DeferredBlock<Block> DECO_NEST_HARPY = BLOCKS.register("deco_nest_harpy", () -> new DecorationBlock(Block.Properties.of().mapColor(MapColor.STONE).strength(0.8F, 6F).sound(SoundType.STONE)));
	public static final DeferredBlock<Block> DOLL_CREEPER_GIRL = BLOCKS.register("doll_creeper_girl", () -> new DecorationBlock(Block.Properties.of().mapColor(MapColor.WOOL).strength(0.8F, 6F).sound(SoundType.WOOL)));
	public static final DeferredBlock<Block> DOLL_DRYAD = BLOCKS.register("doll_dryad", () -> new DecorationBlock(Block.Properties.of().mapColor(MapColor.WOOL).strength(0.8F, 6F).sound(SoundType.WOOL)));
	public static final DeferredBlock<Block> DOLL_DULLAHAN = BLOCKS.register("doll_dullahan", () -> new DecorationBlock(Block.Properties.of().mapColor(MapColor.WOOL).strength(0.8F, 6F).sound(SoundType.WOOL)));
	public static final DeferredBlock<Block> DOLL_ENDER_GIRL = BLOCKS.register("doll_ender_girl", () -> new DecorationBlock(Block.Properties.of().mapColor(MapColor.WOOL).strength(0.8F, 6F).sound(SoundType.WOOL)));
	public static final DeferredBlock<Block> DOLL_MAID = BLOCKS.register("doll_maid", () -> new DecorationBlock(Block.Properties.of().mapColor(MapColor.WOOL).strength(0.8F, 6F).sound(SoundType.WOOL)));
	public static final DeferredBlock<Block> DOLL_MERMAID = BLOCKS.register("doll_mermaid", () -> new DecorationBlock(Block.Properties.of().mapColor(MapColor.WOOL).strength(0.8F, 6F).sound(SoundType.WOOL)));
	public static final DeferredBlock<Block> DOLL_NINE_TAILS = BLOCKS.register("doll_nine_tails", () -> new DecorationBlock(Block.Properties.of().mapColor(MapColor.WOOL).strength(0.8F, 6F).sound(SoundType.WOOL)));
	public static final DeferredBlock<Block> DOLL_SLIME_GIRL = BLOCKS.register("doll_slime_girl", () -> new DecorationBlock(Block.Properties.of().mapColor(MapColor.WOOL).strength(0.8F, 6F).sound(SoundType.WOOL)));
	...
	//BlockItems
	public static final DeferredItem<Item> BUST_GORGON_ITEM = ITEMS.register("bust_gorgon", () -> new BlockItem(BUST_GORGON.get(), itemBuilder()));
	public static final DeferredItem<Item> BUST_MINOTAUR_ITEM = ITEMS.register("bust_minotaur", () -> new BlockItem(BUST_MINOTAUR.get(), itemBuilder()));
	public static final DeferredItem<Item> BUST_SPHINX_ITEM = ITEMS.register("bust_sphinx", () -> new BlockItem(BUST_SPHINX.get(), itemBuilder()));
	public static final DeferredItem<Item> BUST_VALKYRIE_ITEM = ITEMS.register("bust_valkyrie", () -> new BlockItem(BUST_VALKYRIE.get(), itemBuilder()));
	public static final DeferredItem<Item> BUST_VAMPIRE_ITEM = ITEMS.register("bust_vampire", () -> new BlockItem(BUST_VAMPIRE.get(), itemBuilder()));
	public static final DeferredItem<Item> DECO_GARDEN_GNOME_ITEM = ITEMS.register("deco_garden_gnome", () -> new BlockItem(DECO_GARDEN_GNOME.get(), itemBuilder()));
	public static final DeferredItem<Item> DECO_MANDRAGORA_POT_ITEM = ITEMS.register("deco_mandragora_pot", () -> new BlockItem(DECO_MANDRAGORA_POT.get(), itemBuilder()));
	public static final DeferredItem<Item> DECO_NEST_HARPY_ITEM = ITEMS.register("deco_nest_harpy", () -> new BlockItem(DECO_NEST_HARPY.get(), itemBuilder()));
	public static final DeferredItem<Item> DOLL_CREEPER_GIRL_ITEM = ITEMS.register("doll_creeper_girl", () -> new BlockItem(DOLL_CREEPER_GIRL.get(), itemBuilder()));
	public static final DeferredItem<Item> DOLL_DRYAD_ITEM = ITEMS.register("doll_dryad", () -> new BlockItem(DOLL_DRYAD.get(), itemBuilder()));
	public static final DeferredItem<Item> DOLL_DULLAHAN_ITEM = ITEMS.register("doll_dullahan", () -> new BlockItem(DOLL_DULLAHAN.get(), itemBuilder()));
	public static final DeferredItem<Item> DOLL_ENDER_GIRL_ITEM = ITEMS.register("doll_ender_girl", () -> new BlockItem(DOLL_ENDER_GIRL.get(), itemBuilder()));
	public static final DeferredItem<Item> DOLL_MAID_ITEM = ITEMS.register("doll_maid", () -> new BlockItem(DOLL_MAID.get(), itemBuilder()));
	public static final DeferredItem<Item> DOLL_MERMAID_ITEM = ITEMS.register("doll_mermaid", () -> new BlockItem(DOLL_MERMAID.get(), itemBuilder()));
	public static final DeferredItem<Item> DOLL_NINE_TAILS_ITEM = ITEMS.register("doll_nine_tails", () -> new BlockItem(DOLL_NINE_TAILS.get(), itemBuilder()));
	public static final DeferredItem<Item> DOLL_SLIME_GIRL_ITEM = ITEMS.register("doll_slime_girl", () -> new BlockItem(DOLL_SLIME_GIRL.get(), itemBuilder()));
	public static final DeferredItem<Item> PEARL_BLOCK_ITEM = ITEMS.register("pearl_block", () -> new BlockItem(PEARL_BLOCK.get(), itemBuilder()));
	...
	public static final DeferredItem<Item> WEAPON_BOOK_ENDER = ITEMS.register("weapon_book_ender", () -> new EnderBookItem(GaiaTiers.BOOK, itemBuilder().rarity(Rarity.RARE)));
	public static final DeferredItem<Item> WEAPON_BOOK_HUNGER = ITEMS.register("weapon_book_hunger", () -> new HungerBookItem(GaiaTiers.BOOK, itemBuilder().rarity(Rarity.RARE)));
	public static final DeferredItem<Item> WEAPON_BOOK_BATTLE = ITEMS.register("weapon_book_battle", () -> new BattleBookItem(GaiaTiers.BOOK, itemBuilder().rarity(Rarity.RARE)));
	...
	public static final DeferredItem<Item> HEADGEAR_BOLT = ITEMS.register("headgear_bolt", () -> new HeadgearItem(itemBuilder().stacksTo(1)));
	public static final DeferredItem<Item> HEADGEAR_ARROW = ITEMS.register("headgear_arrow", () -> new HeadgearItem(itemBuilder().stacksTo(1)));
	public static final DeferredItem<Item> HEADGEAR_DOLL = ITEMS.register("headgear_doll", () -> new HeadgearItem(itemBuilder().stacksTo(1)));
	public static final DeferredItem<Item> HEADGEAR_EARS_ELF = ITEMS.register("headgear_ears_elf", () -> new HeadgearItem(itemBuilder().stacksTo(1)));
	public static final DeferredItem<Item> KNUCKLES = ITEMS.register("knuckles", () -> new KnucklesItem(itemBuilder().stacksTo(1)));
	public static final DeferredItem<Item> SEASHELL_HAIRPIN = ITEMS.register("seashell_hairpin", () -> new SeashellHairpinItem(itemBuilder().durability(1)));
	public static final DeferredItem<Item> RING_OF_SPEED = ITEMS.register("ring_of_speed", () -> new RingItem(itemBuilder(),
			List.of(() -> new MobEffectInstance(MobEffects.MOVEMENT_SPEED, 5 * 20, 1, true, false))));
	public static final DeferredItem<Item> RING_OF_HASTE = ITEMS.register("ring_of_haste", () -> new RingItem(itemBuilder(),
			List.of(() -> new MobEffectInstance(MobEffects.DIG_SPEED, 5 * 20, 1, true, false))));
	public static final DeferredItem<Item> RING_OF_JUMP = ITEMS.register("ring_of_jump", () -> new RingItem(itemBuilder(),
			List.of(() -> new MobEffectInstance(MobEffects.JUMP, 5 * 20, 1, true, false))));
	public static final DeferredItem<Item> RING_OF_NIGHT = ITEMS.register("ring_of_night", () -> new RingItem(itemBuilder(),
	...
	public static final DeferredItem<Item> SOULFIRE = ITEMS.register("soulfire", () -> new SoulfireItem(itemBuilder()));
	public static final DeferredItem<Item> STONE_COAL = ITEMS.register("stone_coal", () -> new FuelItem(itemBuilder(), 3600));
	public static final DeferredItem<Item> TAPROOT = ITEMS.register("taproot", () -> new TaprootItem(itemBuilder().food(GaiaFoods.TAPROOT)));
	public static final DeferredItem<Item> ZOMBIE_STAFF = ITEMS.register("zombie_staff", () -> new SummonStaffItem(itemBuilder().rarity(Rarity.RARE).durability(10), () -> EntityType.ZOMBIE, () -> Ingredient.of(Items.ROTTEN_FLESH)));
	public static final DeferredItem<Item> SKELETON_STAFF = ITEMS.register("skeleton_staff", () -> new SummonStaffItem(itemBuilder().rarity(Rarity.RARE).durability(10), () -> EntityType.SKELETON, () -> Ingredient.of(Items.BONE)));
	public static final DeferredItem<Item> CAVE_SPIDER_STAFF = ITEMS.register("cave_spider_staff", () -> new SummonStaffItem(itemBuilder().rarity(Rarity.RARE).durability(10), () -> EntityType.CAVE_SPIDER, () -> Ingredient.of(Items.SPIDER_EYE)));
	public static final DeferredItem<Item> MAGIC_STAFF = ITEMS.register("magic_staff", () -> new MagicStaffItem(itemBuilder().rarity(Rarity.RARE).durability(64), () -> EntityType.CAVE_SPIDER));
	...
	public static final DeferredItem<Item> PROJECTILE_BOMB = ITEMS.register("projectile_bomb", () -> new BombItem(itemBuilder().stacksTo(1)));
	...
	//Lootable Item
	public static final DeferredItem<Item> BAG_ARROWS = ITEMS.register("bag_arrows", () -> new LootableItem(itemBuilder().rarity(Rarity.RARE), GaiaLootTables.BAG_ARROW, GaiaSounds.BAG_OPEN));
	public static final DeferredItem<Item> BAG_BOOK = ITEMS.register("bag_book", () -> new LootableItem(itemBuilder().rarity(Rarity.RARE), GaiaLootTables.BAG_BOOK, GaiaSounds.BAG_OPEN));
	public static final DeferredItem<Item> BAG_RECORD = ITEMS.register("bag_record", () -> new LootableItem(itemBuilder().rarity(Rarity.RARE), GaiaLootTables.BAG_RECORD, GaiaSounds.BAG_OPEN));
	public static final DeferredItem<Item> BOX_DIAMOND = ITEMS.register("box_diamond", () -> new LootableItem(itemBuilder().rarity(Rarity.RARE), GaiaLootTables.BOXES_DIAMOND, GaiaSounds.BOX_OPEN));
	public static final DeferredItem<Item> BOX_END = ITEMS.register("box_end", () -> new LootableItem(itemBuilder().rarity(Rarity.RARE), GaiaLootTables.BOXES_END, GaiaSounds.BOX_OPEN));
	public static final DeferredItem<Item> BOX_GOLD = ITEMS.register("box_gold", () -> new LootableItem(itemBuilder().rarity(Rarity.RARE), GaiaLootTables.BOXES_GOLD, GaiaSounds.BOX_OPEN));
	public static final DeferredItem<Item> BOX_HAT = ITEMS.register("box_hat", () -> new LootableItem(itemBuilder(), GaiaLootTables.BOXES_HAT, GaiaSounds.BOX_OPEN));
	public static final DeferredItem<Item> BOX_IRON = ITEMS.register("box_iron", () -> new LootableItem(itemBuilder().rarity(Rarity.RARE), GaiaLootTables.BOXES_IRON, GaiaSounds.BOX_OPEN));
	public static final DeferredItem<Item> BOX_NETHER = ITEMS.register("box_nether", () -> new LootableItem(itemBuilder().rarity(Rarity.RARE), GaiaLootTables.BOXES_NETHER, GaiaSounds.BOX_OPEN));
	public static final DeferredItem<Item> BOX_OLD = ITEMS.register("box_old", () -> new LootableItem(itemBuilder().rarity(Rarity.RARE), GaiaLootTables.BOXES_OLD, GaiaSounds.BOX_OPEN));
	public static final DeferredItem<Item> BOX_OVERWORLD = ITEMS.register("box_overworld", () -> new LootableItem(itemBuilder().rarity(Rarity.RARE).rarity(Rarity.RARE), GaiaLootTables.BOXES_OVERWORLD, GaiaSounds.BOX_OPEN));
	public static final DeferredItem<Item> BOX_EGG = ITEMS.register("box_egg", () -> new LootableItem(itemBuilder().rarity(Rarity.RARE).rarity(Rarity.RARE), GaiaLootTables.BOXES_EGG, GaiaSounds.BOX_OPEN));
	public static final DeferredItem<Item> CHEST_DESERT = ITEMS.register("chest_desert", () -> new LootableItem(itemBuilder().rarity(Rarity.RARE), BuiltInLootTables.DESERT_PYRAMID, GaiaSounds.BOX_OPEN));
	public static final DeferredItem<Item> CHEST_DUNGEON = ITEMS.register("chest_dungeon", () -> new LootableItem(itemBuilder().rarity(Rarity.RARE), BuiltInLootTables.SIMPLE_DUNGEON, GaiaSounds.BOX_OPEN));
	public static final DeferredItem<Item> CHEST_JUNGLE = ITEMS.register("chest_jungle", () -> new LootableItem(itemBuilder().rarity(Rarity.RARE), BuiltInLootTables.JUNGLE_TEMPLE, GaiaSounds.BOX_OPEN));
