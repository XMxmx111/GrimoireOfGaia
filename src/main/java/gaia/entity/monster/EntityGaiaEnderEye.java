...
public class EntityGaiaEnderEye extends EntityMobBase
{
    ...
    public EntityGaiaEnderEye(World worldIn)
    {
        ...
        //this.tasks.addTask(10, new EntityGaiaEnderEye.AIPlaceBlock(this));
        //this.tasks.addTask(11, new EntityGaiaEnderEye.AITakeBlock(this));
    ...
    protected void playStepSound(int par1, int par2, int par3, int par4) {
        //TODO double check no sound working
    ...
    static class AIPlaceBlock extends EntityAIBase
    {
        ...
        public AIPlaceBlock(EntityGaiaEnderEye p_i45843_1_)
        {
    ...
    static class AITakeBlock extends EntityAIBase
    {
        ...
        public AITakeBlock(EntityGaiaEnderEye p_i45841_1_)
        {
        ...
        public void updateTask()
        {
            ...
            if (EntityGaiaEnderEye.carriableBlocks.contains(block))
            {
